  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (balanceData.balanceIncomeSum || balanceData.balanceCostSum) {
          const total =
            balanceData.balanceIncomeSum - balanceData.balanceCostSum;
          const costs = balanceData.balanceCostSum ?? 0;
          const income = balanceData.balanceIncomeSum ?? 0;
